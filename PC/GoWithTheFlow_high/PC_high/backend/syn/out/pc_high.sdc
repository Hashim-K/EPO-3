...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Wed Dec 16 16:26:00 CET 2020
...
current_design pc_high

set_load -pin_load 1.0 [get_ports {adh_out[7]}]
set_load -pin_load 1.0 [get_ports {adh_out[6]}]
set_load -pin_load 1.0 [get_ports {adh_out[5]}]
set_load -pin_load 1.0 [get_ports {adh_out[4]}]
set_load -pin_load 1.0 [get_ports {adh_out[3]}]
set_load -pin_load 1.0 [get_ports {adh_out[2]}]
set_load -pin_load 1.0 [get_ports {adh_out[1]}]
set_load -pin_load 1.0 [get_ports {adh_out[0]}]
...
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports adh_pch]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports pch_adh]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports pch_db]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports pclc]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {adh_in[7]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {adh_in[6]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {adh_in[5]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {adh_in[4]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {adh_in[3]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {adh_in[2]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {adh_in[1]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {adh_in[0]}]
