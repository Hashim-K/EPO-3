...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Wed Dec 16 15:06:30 CET 2020
...
current_design adder_hold_register

set_load -pin_load 1.0 [get_ports {adl[7]}]
set_load -pin_load 1.0 [get_ports {adl[6]}]
set_load -pin_load 1.0 [get_ports {adl[5]}]
set_load -pin_load 1.0 [get_ports {adl[4]}]
set_load -pin_load 1.0 [get_ports {adl[3]}]
set_load -pin_load 1.0 [get_ports {adl[2]}]
set_load -pin_load 1.0 [get_ports {adl[1]}]
set_load -pin_load 1.0 [get_ports {adl[0]}]
set_load -pin_load 1.0 [get_ports {sb[7]}]
set_load -pin_load 1.0 [get_ports {sb[6]}]
set_load -pin_load 1.0 [get_ports {sb[5]}]
set_load -pin_load 1.0 [get_ports {sb[4]}]
set_load -pin_load 1.0 [get_ports {sb[3]}]
set_load -pin_load 1.0 [get_ports {sb[2]}]
set_load -pin_load 1.0 [get_ports {sb[1]}]
set_load -pin_load 1.0 [get_ports {sb[0]}]
...
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {alu_data_in[7]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {alu_data_in[6]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {alu_data_in[5]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {alu_data_in[4]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {alu_data_in[3]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {alu_data_in[2]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {alu_data_in[1]}]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports {alu_data_in[0]}]
