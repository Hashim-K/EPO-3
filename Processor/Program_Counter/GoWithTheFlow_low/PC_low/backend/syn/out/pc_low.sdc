...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Wed Dec 16 16:23:37 CET 2020
...
current_design pc_low

set_load -pin_load 1.0 [get_ports pclc]
...
set_load -pin_load 1.0 [get_ports {db_out[7]}]
set_load -pin_load 1.0 [get_ports {db_out[6]}]
set_load -pin_load 1.0 [get_ports {db_out[5]}]
set_load -pin_load 1.0 [get_ports {db_out[4]}]
set_load -pin_load 1.0 [get_ports {db_out[3]}]
set_load -pin_load 1.0 [get_ports {db_out[2]}]
set_load -pin_load 1.0 [get_ports {db_out[1]}]
set_load -pin_load 1.0 [get_ports {db_out[0]}]
...
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports i_pc]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports pcl_adl]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports pcl_db]
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports adl_pcl]
