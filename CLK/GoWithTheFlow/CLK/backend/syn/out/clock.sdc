...
#  Created by Genus(TM) Synthesis Solution 17.11-s014_1 on Wed Dec 16 16:00:08 CET 2020
...
set_load -pin_load 1.0 [get_ports clk]
set_load -pin_load 1.0 [get_ports clk_2]
set_load -pin_load 1.0 [get_ports clk_3]
set_clock_gating_check -setup 0.0 
set_driving_cell -lib_cell INVD0BWP7T -library tcb018gbwp7twc -pin "ZN" [get_ports clk_25mhz]
